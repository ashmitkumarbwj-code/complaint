...
exports.validateSubmitComplaint = [
    ...
    body('student_id')
        .optional({ checkFalsy: true })
        .customSanitizer(val => (val === 'undefined' || val === 'null' || isNaN(val)) ? undefined : parseInt(val, 10)),
    body('title')
        .trim()
    ...
    body('category')
        ...
        .isIn(['Noise', 'Electricity', 'Infrastructure', 'Mess', 'Security', 'Harassment', 'Faculty', 'Cleanliness', 'Other'])
